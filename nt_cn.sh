...
downloadBinrayFile() {
    ...
    for i in {1..3}; do
        ...
        downloadUrls=https://hub.gitmirror.com/https://github.com/gdyan2022/NTrace-core/releases/latest/download/nexttrace_${osDistribution}_${archParam}
        # echo -e "${downloadUrls}"
        if [ $? -eq 0 ]; then
            break
        fi
